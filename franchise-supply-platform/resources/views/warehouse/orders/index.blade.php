                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                @if($order->status == 'approved')
                                    <span class="badge bg-info rounded-pill order-status-badge">Awaiting Fulfillment</span>
                                @elseif($order->status == 'packed')
                                    <span class="badge bg-warning rounded-pill order-status-badge">In Progress</span>
                                @elseif($order->status == 'shipped')
                                    <span class="badge bg-primary rounded-pill order-status-badge">Shipped</span>
                                ...
                                @elseif($order->status == 'pending')
                                    <span class="badge bg-secondary rounded-pill order-status-badge">Pending Approval</span>
                                @else
