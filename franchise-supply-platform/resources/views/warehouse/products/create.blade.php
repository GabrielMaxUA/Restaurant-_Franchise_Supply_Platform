...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('warehouse.products.store') }}" method="POST" enctype="multipart/form-data" id="product-form">
            @csrf
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="form-group file-section" id="variant-image-section-0">
                                    ...
                                    <small class="text-muted">You can select multiple images for each variant</small>
            ...
            <div class="d-flex justify-content-between">
                <a href="{{ route('warehouse.products.index') }}" class="btn btn-secondary">Cancel</a>
