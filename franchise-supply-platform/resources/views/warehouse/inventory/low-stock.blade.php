                ...
                <div class="card-body">
                            ...
                            <table class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Category</th>
                                        <th>Base Price</th>
                                        <th class="text-danger">Inventory Count</th>
                                        <th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($products as $product)
                                        <tr>
                                            ...
                                            <td class="text-danger font-weight-bold">{{ $product->inventory_count }}</td>
                                            <td>
                    ...
                    @else
                        <div class="alert alert-info">
                            <i class="fas fa-info-circle"></i> No low stock products found.
                        </div>
                    @endif
                </div>
            </div>
