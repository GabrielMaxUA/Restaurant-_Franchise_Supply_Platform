...
@section('title', 'My Profile - Warehouse Portal')
            ...
            <form action="{{ route('warehouse.profile.update') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control bg-light" id="role" value="{{ $user->role ? ucfirst($user->role->name) : 'Warehouse' }}" readonly>
                    </div>
                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a href="{{ route('warehouse.settings', ['tab' => 'password']) }}" class="btn btn-outline-primary btn-sm">
