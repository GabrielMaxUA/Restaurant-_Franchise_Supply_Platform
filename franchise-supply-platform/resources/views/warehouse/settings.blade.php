...
@section('title', 'Account Settings - Warehouse Portal')
...
<div class="container">
    <div class="action-bar">
        <a href="{{ route('warehouse.profile') }}" class="back-link">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="centered-form" action="{{ route('warehouse.profile.change-password') }}" method="POST">
                @csrf
